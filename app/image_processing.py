...
VERTICAL_THRESHOLD= int(0.25 * RESOLUTION)
VERTICAL_MIN_LINE_LENGTH= int(0.25 * RESOLUTION)
...
HORIZONTAL_THRESHOLD= int(0.01 * RESOLUTION)
HORIZONTAL_MIN_LINE_LENGTH= int(0.05 * RESOLUTION)
HORIZONTAL_MAX_LINE_GAP= int(0.6 * RESOLUTION)
HORIZONTAL_MIN_DISTANCE= int(0.09 * RESOLUTION)

MIN_DISTANCE_TO_CONTOUR = int(0.05 * RESOLUTION)

# island lower limit
ISLAND_SIZE_TRESHOLD = 0.0009 * RESOLUTION * RESOLUTION
# add upper limit
TRIANGLE_AREA_TRESHOLD_MIN = 0.005 * RESOLUTION * RESOLUTION
TRIANGLE_AREA_TRESHOLD_MAX = 0.10 * RESOLUTION * RESOLUTION
CONTOUR_TRESHOLD = 17
